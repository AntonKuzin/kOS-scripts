...
if ramJetEngines:LENGTH > 0 or jetEngines:LENGTH > 0
{
	...
	local maxRamJetEngineTemp is 3153.
	local ramJetEngineThrustLimit is 100.
	
	local maxJetEngineTemp is 648.
	...
	until false
	{
		...
		if ramJetEngineTemp >= maxRamJetEngineTemp
		{
			...
			print "lowered ramJet engine thrust limit to " + ramJetEngineThrustLimit.
		}
		...
		if jetEngineTemp >= maxJetEngineTemp
		{
			...
			print "lowered jet engine thrust limit to " + jetEngineThrustLimit.
		}
